...
INPUT_FILE = Path("data/openfoodfacts_poland.jsonl")
OUTPUT_FILE = Path("data/openfoodfacts_poland_clean.csv")

FIELDS = [
    "code", "product_name", "brands", "stores", "categories",
    "nutriscore_grade", "nova_group", "ecoscore_grade", "countries",
